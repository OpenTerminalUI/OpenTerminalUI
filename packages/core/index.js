...
switch (platform) {
    ...
    switch (arch) {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'openterminal-ui-core.android-arm-eabi.node'),
        );
        try {
          if (localFileExisted) {
  ...
  case 'win32':
    switch (arch) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'openterminal-ui-core.win32-arm64-msvc.node'),
        );
        try {
          if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'openterminal-ui-core.linux-x64-musl.node'),
          );
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'openterminal-ui-core.linux-arm64-musl.node'),
          );
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'openterminal-ui-core.linux-arm64-gnu.node'),
          );
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'openterminal-ui-core.linux-arm-gnueabihf.node'),
        );
        try {
          if (localFileExisted) {
