...
import { readFile, highlightCode } from '@openterminal-ui/core';
...
export const CodeViewer: React.FC<CodeViewerProps> = ({ filePath, isActive }) => {
  ...
  return (
    <Box flexDirection="column" borderStyle={isActive ? "double" : "single"} borderColor={isActive ? "blue" : "gray"} padding={1} flexGrow={1}>
      <Text bold color="yellow">{filePath || "Code Viewer"}</Text>
